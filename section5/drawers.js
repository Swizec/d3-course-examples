...
var Drawers = function (svg, ufos, populations, geo_path, geo_projection) {
    return {
        ...
        bases: function (military_bases, geo_projection) {
            var base_positions = prepare.base_positions(military_bases,
                                                        geo_projection);
        ...
        place_ufos: function (ufos) {
            ...
            ufos = _.sortBy(ufos,
                            function (ufo) { return format.parse(ufo.time); });
            ...
            d3.timer((function (counter) {
                ...
                return function draw () {
                    ...
                    if (!(to_draw.pos.length || to_draw.ufos.length)) {
                        return;
                    }
                    ...
                    var g = svg.append("g")
                        ...
                        centroids = d3.selectAll(to_draw.ufos.map(
                            function (ufo) {
